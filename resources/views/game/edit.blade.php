...
<body>
<form action="/update-game/{{$game->id}}" method="POST" enctype="multipart/form-data">
  @csrf
  @method('PUT')
  <div>
    <label for="name">სახელი:</label>
    <input type="texr" name="name" id="name" value="{{$game->name}}">
  </div>
  <div>
  ...
  <div>
    ...
    <textarea name="description" id="game_description" >{{$game->description}}</textarea>
  </div>
  ...
  <div>
    ...
    <div>
      ...
      <input type="text" name="os" id="os" value="{{$game->requirements->os}}"/>
    </div>
    <div>
      <label for="gpu">GPU:</label>
      <input type="text" name="gpu" id="gpu" value="{{$game->requirements->gpu}}">
    </div>
    <div>
      <label for="cpu">CPU:</label>
      <input type="text" name="cpu" id="cpu" value="{{$game->requirements->cpu}}">
    </div>
    <div>
      <label for="ram">RAM:</label>
      <input type="text" name="ram" id="ram" value="{{$game->requirements->ram}}">
    </div>
  </div>
  ...
  <div>
    ...
    <input type="text" name="download_link" id="download_link" value="{{$game->download_link}}">
  </div>
